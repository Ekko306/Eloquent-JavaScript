...
// // if I create two new values {value: 0, rest: list} and {value: -1, rest: list} (with list referring
...
// // list that adds the element to the front of the input list, and nth, which takes a list
// // and a number and returns the element at the given position in the list (with zero
...
// their properties compared, you can use the typeof operator. If it produces "object" for both values,
// you should do a deep comparison. But you have to take one silly exception into account: because of
